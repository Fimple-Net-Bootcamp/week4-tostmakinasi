...
namespace VirtualPetCare.Repository.Migrations
{
    ...
    [Migration("20231215144513_Activity-Pet_Addedrelation")]
    partial class ActivityPet_Addedrelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Activity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 732, DateTimeKind.Utc).AddTicks(7691));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.ActivityHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(1198));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(2535));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.FoodHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(4855));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Health", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(6183));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Pet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(7227));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.PetSpecies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(8436));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 45, 12, 733, DateTimeKind.Utc).AddTicks(9448));
