...
namespace VirtualPetCare.Repository.Migrations
{
    ...
    [Migration("20231215095455_Health_AddedPetNavigtion")]
    partial class Health_AddedPetNavigtion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Activity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 137, DateTimeKind.Utc).AddTicks(7008));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.ActivityHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(1108));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(2600));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.FoodHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(4982));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Health", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(6306));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Pet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(7428));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.PetSpecies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(8615));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 9, 54, 55, 138, DateTimeKind.Utc).AddTicks(9672));
