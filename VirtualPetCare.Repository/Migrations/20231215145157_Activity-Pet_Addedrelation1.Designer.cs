...
namespace VirtualPetCare.Repository.Migrations
{
    ...
    [Migration("20231215145157_Activity-Pet_Addedrelation1")]
    partial class ActivityPet_Addedrelation1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityPetSpecies", b =>
                {
                    ...
                    b.HasKey("ActivitiesId", "PetSpeciesId");

                    b.HasIndex("PetSpeciesId");

                    b.ToTable("ActivityPetSpecies");
                });
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Activity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 429, DateTimeKind.Utc).AddTicks(6721));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.ActivityHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(183));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Food", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(1854));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.FoodHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(4422));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Health", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(5737));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Pet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(6842));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.PetSpecies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(8069));
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2023, 12, 15, 14, 51, 57, 430, DateTimeKind.Utc).AddTicks(9205));
            ...
            modelBuilder.Entity("ActivityPetSpecies", b =>
                {
                    ...
                    b.HasOne("VirtualPetCare.Core.Models.PetSpecies", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VirtualPetCare.Core.Models.Pet", b =>
                {
                    b.HasOne("VirtualPetCare.Core.Models.Health", "Health")
                        .WithOne("Pet")
                        .HasForeignKey("VirtualPetCare.Core.Models.Pet", "HealthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
